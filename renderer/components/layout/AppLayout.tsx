  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="flex items-center h-8 bg-background border-b border-border/40 app-drag-region">
        <div className="flex-1 px-3 text-xs font-medium text-muted-foreground/80 truncate">
          {getAppTitle()}
          <span className="ml-2 text-[10px] text-muted-foreground/60">{getVersionString()}</span>
        </div>
